...
package com.soar.debug.arthropodDebugger {
	...
	public class Debug {
		...
		public static var RED					:uint = 0xD22346;
		public static var YELLOW			:uint = 0xFFD030;
		public static var ORANGES		:uint = 0xCC6633;
		public static var GREEN				:uint = 0x669933;
		public static var PINK				:uint = 0xEA66A6;
		public static var BLUE				:uint = 0x4183C4;
		public static var LIGHT_BLUE	:uint = 0x00CCCC;
		...
		public static function log ( message:*, color:uint = 0xFEFEFE ) :Boolean {
			...
			return send ( LOG_OPERATION, String ( caller + " - " + message ) , color ) ;
			*/
		}
