package com.soar.ui {
	...
	public class GridCanvars extends Shape {
		
		public function GridCanvars() {
		
		}
		
		static public function drawGirdCanvars(squareW:int, squareH:int, cols:int, rows:int):Shape {
