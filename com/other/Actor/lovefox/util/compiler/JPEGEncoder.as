package lovefox.util.compiler
{
    ...
    final public class JPEGEncoder extends Object
    {
        ...
        public function JPEGEncoder(param1:int = 50)
        {
            ...
            this.bitcode = new Vector.<>(65535, true);
        ...
        private function computeHuffmanTbl(param1:Vector.<int>, param2:Vector.<int>) : Vector.<BitString>
        {
            ...
            var _loc_3:* = 0;
            var _loc_4:* = 0;
            var _loc_5:* = new Vector.<>(251, true);
            var _loc_7:* = 1;
            while (_loc_7 <= 16)
            {
        ...
        public function encode(param1:BitmapData) : ByteArray
        {
            ...
            while (_loc_7 < _loc_6)
            {
                ...
                while (_loc_8 < _loc_5)
                {
                    ...
                    this.RGB2YUV(param1, _loc_8, _loc_7);
            ...
            if (this.bytepos >= 0)
            {
                _loc_9 = new BitString();
                _loc_9.len = this.bytepos + 1;
                _loc_9.val = (1 << (this.bytepos + 1)) - 1;
                this.writeBits(_loc_9);
            }
