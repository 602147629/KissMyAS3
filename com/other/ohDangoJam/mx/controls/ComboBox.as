...
{
    var editable, __set__editable, __labels, data, __dropdownWidth, __width, __set__dropdownWidth, _editable, selectedIndex, __dropdown, dataProvider, __labelFunction, owner, wrapDownArrowButton, _y, createObject, mask, border_mc, text_mc, __get__selectedLabel, __get__labels, __get__labelField, __get__labelFunction, getValue, dispatchValueChangedEvent, length, __get__rowCount, __get__dropdownWidth, selectedItem, isPressed, __set__visible, height, localToGlobal, __selectedIndexOnDropdown, __get__height, getStyle, _parent, __get__dropdown, width, __dataProvider, selected, dispatchEvent, __set__labelField, __set__labelFunction, __set__labels, __set__rowCount;
    function ComboBox()
    {
        super();
    } // End of the function
