package network
{
    ...
    public class NetTaskWareHouseReceiveAll extends NetTask
    {

        public function NetTaskWareHouseReceiveAll(param1:Function, param2:int, param3:int)
        {
            super(NetId.PROTOCOL_WAREHOUSE_ALL_RECEIVE, param1);
            _param.limitFlag = param2;
            _param.filter = param3;
            return;
        }// end function
