package script
{
    ...
    public class ScriptComMoviePlay extends ScriptComBase
    {
        private const _PHASE_FADE_START_OUT:int = 1;
        private const _PHASE_PLAY_START:int = 2;
        private const _PHASE_FADE_START_IN:int = 3;
        private const _PHASE_PLAY:int = 4;
        private const _PHASE_FADE_END_OUT:int = 5;
        private const _PHASE_FADE_END_IN:int = 6;
        ...
        public function ScriptComMoviePlay()
        {
        ...
        {
            super.commandInit();
            this.setPhase(this._PHASE_FADE_START_OUT);
            return;
        }// end function
        ...
        override public function commandControl(param1:Number) : void
        {
            ...
            switch(this._phase)
            {
                case this._PHASE_FADE_START_OUT:
                {
                ...
                case this._PHASE_FADE_END_OUT:
                {
                    ...
                    {
                        _loc_3.playEnd();
                        this.setPhase(this._PHASE_FADE_END_IN);
                    }
                    break;
                }
                case this._PHASE_FADE_END_IN:
                {
                    _loc_2 = ScriptManager.getInstance().getFade();
                    if (_loc_2.bFadeEnd)
                    {
