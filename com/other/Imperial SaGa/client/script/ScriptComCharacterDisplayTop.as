package script
{
    ...
    public class ScriptComCharacterDisplayTop extends ScriptComBase
    {
        private var _name:String;
        private var _pos:Point;
        private var _bTurnOver:Boolean;

        public function ScriptComCharacterDisplayTop()
        {
        ...
        {
            super.commandInit();
            var _loc_1:* = ScriptManager.getInstance().getLayerCharacterTop();
            if (_loc_1 == null)
            {
