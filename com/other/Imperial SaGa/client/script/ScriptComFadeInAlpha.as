package script
{
    ...
    public class ScriptComFadeInAlpha extends ScriptComBase
    {
        private var _waitTime:Number;
        private var _color:uint;
        private var _alpha:Number;

        public function ScriptComFadeInAlpha()
        {
        ...
        override public function commandInit() : void
        {
            ...
            _loc_1.setParamFadeIn(this._waitTime, this._color, this._alpha);
            return;
        }// end function
