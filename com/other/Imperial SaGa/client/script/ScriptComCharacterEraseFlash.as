package script
{
    ...
    public class ScriptComCharacterEraseFlash extends ScriptComBase
    {
        private var _name:String;
        private var _useTime:Number;
        private var _time:Number;

        public function ScriptComCharacterEraseFlash()
        {
        ...
        override public function commandControl(param1:Number) : void
        {
            ...
            if (this._useTime > 0)
            {
                ...
                _loc_2.alpha = _loc_3;
                _loc_4 = this._time % 0.2;
                _loc_2.setVisible(_loc_4 > 0.1);
            }
