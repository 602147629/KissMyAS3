package formationSkill
{
    ...
    public class FormationSkillTimingAttack extends FormationSkillBase
    {
        private static const aNotDisplayWeapon:Array = [CommonConstant.CHARACTER_WEAPONTYPE_BOW, CommonConstant.CHARACTER_WEAPONTYPE_CLUB, CommonConstant.CHARACTER_WEAPONTYPE_MATERIALARTS];

        public function FormationSkillTimingAttack(param1:LayerBattle, param2:Array, param3:Array, param4:EffectManager)
        {
            super(param1, param2, param3, param4);
            _mc = ResourceManager.getInstance().createMovieClip(getResource(), "advance_chara_act");
            setTarget(_aTarget[0]);
            _aNullMc = [_mc.charaNull, _mc.charaNull2];
        ...
        {
            return ResourcePath.FORMATION_SKILL_PATH + "FormationSkill_TimingAttack.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            return [SoundId.SE_TIMESHIFT, SoundId.SE_RS3_SWORD_LONG_SWORD_NORMAL_ATTACK, SoundId.SE_JUMP3];
        }// end function
