package formationSkill
{
    ...
    public class FormationSkillExcelDriver extends FormationSkillBase
    {
        private var _effAfterImage:EffectAfterImage;
        private var frame:int;
        private static const WAIT_FRAME:int = 4;

        public function FormationSkillExcelDriver(param1:LayerBattle, param2:Array, param3:Array, param4:EffectManager)
        {
            super(param1, param2, param3, param4);
            _mc = ResourceManager.getInstance().createMovieClip(getResource(), "advance_chara_act");
            _mc.gotoAndStop(_ACT_LABEL_STOP);
            setTarget(_aTarget[0]);
            _aNullMc = [_mc.charaNull, _mc.charaNull2, _mc.charaNull3];
        ...
        override public function setWeapon() : void
        {
            ...
            while (_loc_1 < _aNullMc.length)
            {
                ...
                if (_loc_4.weaponType == CommonConstant.CHARACTER_WEAPONTYPE_SPEAR)
                {
                    _loc_5 = _loc_3.charamove.getChildByName("weaponNull") as MovieClip;
                ...
                {
                    Assert.print("陣形技：エクセルドライバーで槍の装備キャラ以外が攻撃に参加しようとしています");
                    DebugLog.print("陣形技：エクセルドライバーで槍の装備キャラ以外が攻撃に参加しようとしています");
                    DebugLog.print("ユニークID：" + _loc_2.playerDisplay.uniqueId + "名前：" + _loc_4.name + "武器タイプ：" + _loc_4.weaponType);
                }
                _loc_1++;
            }
            SoundManager.getInstance().playSe(SoundId.SE_SET2);
            return;
        }// end function
        ...
        override protected function phaseApproach() : void
        {
            ...
            while (_loc_1 < _aNullMc.length && _loc_1 < _aAttacer.length)
            {
                ...
                _loc_2.charamove.gotoAndStop(_ACT_LABEL_STOP);
                _loc_1++;
            }
            return;
        }// end function
        ...
        override protected function phaseAction() : void
        {
            ...
            while (_loc_1 < _aNullMc.length)
            {
                ...
                if (_loc_2 != null && _loc_3 != null)
                {
                    ...
                    _loc_4.setAnimationPattern(_loc_3.charamove);
                    _loc_3.gotoAndPlay(_ACT_LABEL_START);
                    _loc_3.charamove.gotoAndPlay(_ACT_LABEL_START);
                }
                _loc_1++;
            }
            this._effAfterImage = new EffectAfterImage(_layer.getLayer(LayerBattle.BACK_EFFECT), _layer.getLayer(LayerBattle.CHARACTER), 0.7);
        ...
        {
            return ResourcePath.FORMATION_SKILL_PATH + "FormationSkill_ExcelDriver.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            return [SoundId.SE_SET2, SoundId.SE_ROUND2, SoundId.SE_ATACK3];
        }// end function
