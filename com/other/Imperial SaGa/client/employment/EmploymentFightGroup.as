package employment
{
    ...
    public class EmploymentFightGroup extends Object
    {
        ...
        public function EmploymentFightGroup(param1:MovieClip, param2:int, param3:int, param4:int, param5:Function)
        {
            this._cbOpen = param5;
            this._cbClose = null;
            this._mcBase = param1;
            this._aCandidatePlayerId = [param2, param3, param4];
            this._aFighter = null;
            this._bIn = false;
            this._bFinish = false;
            this._bEnd = false;
            this._animBox = new WinLoseAnimBox(this._mcBase["Cha01"]);
            this._aFighter = [new EmploymentFighter(this._mcBase["Cha01"]), new EmploymentFighter(this._mcBase["Cha02"]), new EmploymentFighter(this._mcBase["Cha03"])];
