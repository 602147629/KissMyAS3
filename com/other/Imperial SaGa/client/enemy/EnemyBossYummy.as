package enemy
{
    ...
    public class EnemyBossYummy extends EnemyDisplayAfterImage
    {

        public function EnemyBossYummy(param1:DisplayObjectContainer, param2:int, param3:int)
        {
            ...
            _blurColor = new ColorTransform(1, 1, 1, 1, 0, 32, 0, 0);
