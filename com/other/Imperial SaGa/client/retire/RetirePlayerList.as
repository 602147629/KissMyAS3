package retire
{
    ...
    public class RetirePlayerList extends PlayerListBase
    {
        ...
        private var _cbOverInsigniaNum:Function;
        private var _overlay:Shape;
        private static const _MULTI_SELECTED_ARRAY_KEY:String = "multi";

        public function RetirePlayerList(param1:MovieClip, param2:Array, param3:int)
        {
            super(param1, param2);
        ...
        override protected function onSelectPlayer(param1:int, param2:ListPlayerDisplay, param3:ListPlayerDisplay) : void
        {
            ...
            var _loc_5:* = this.getMultiSelectPlayerUniqueIdArray();
            this.getMultiSelectPlayerUniqueIdArray().push(param2.playerDisplay.uniqueId);
            if (UserDataManager.getInstance().userData.goldInsignia + RetireUtility.calcGoldInsigniaNum(_loc_5) > CommonConstant.OWN_ITEM_MAX_INSIGNIA || UserDataManager.getInstance().userData.silverInsignia + RetireUtility.calcSilverInsigniaNum(_loc_5) > CommonConstant.OWN_ITEM_MAX_INSIGNIA)
            {
                if (this._cbOverInsigniaNum != null)
                {
                    this._cbOverInsigniaNum(param1, param2.playerData);
                }
                return;
            }
        ...
        public function setOverInsigniaNumCallback(param1:Function) : void
        {
            this._cbOverInsigniaNum = param1;
            return;
        }// end function
