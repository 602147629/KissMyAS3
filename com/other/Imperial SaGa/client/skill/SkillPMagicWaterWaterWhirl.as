package skill
{
    ...
    public class SkillPMagicWaterWaterWhirl extends SkillMagicBase
    {

        public function SkillPMagicWaterWaterWhirl(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_PATH + "Magic_Water_WaterWhirl.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            var _loc_1:* = [SkillMagicBase._TEMP_CASTING_SE, SoundId.SE_BATTLE_WATER, SoundId.SE_LIGHT2];
            return _loc_1;
        }// end function
