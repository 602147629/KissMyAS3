package skill
{
    ...
    public class SkillEMartialArtTripleAttack extends SkillPositionBase
    {

        public function SkillEMartialArtTripleAttack(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_ENEMY_PATH + "Skill_MartialArt_TripleAttack.swf";
        }// end function
