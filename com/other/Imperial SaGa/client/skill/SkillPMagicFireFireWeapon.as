package skill
{
    ...
    public class SkillPMagicFireFireWeapon extends SkillMagicBase
    {

        public function SkillPMagicFireFireWeapon(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_PATH + "Magic_Fire_FireWeapon.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            var _loc_1:* = [SkillMagicBase._TEMP_CASTING_SE, SoundId.SE_BATTLE_FIRE, SoundId.SE_RS3_SYSTEM_SKILL_ENTER];
            return _loc_1;
        }// end function
