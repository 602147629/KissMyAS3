package skill
{
    ...
    public class SkillEMartialArtNeedlePoison extends SkillPositionBase
    {

        public function SkillEMartialArtNeedlePoison(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_ENEMY_PATH + "Skill_MartialArt_NeedlePoison.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            var _loc_1:* = [SoundId.SE_ATACK1, SoundId.SE_SWISH];
            return _loc_1;
        }// end function
