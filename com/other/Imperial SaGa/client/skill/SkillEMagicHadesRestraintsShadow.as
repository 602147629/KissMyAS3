package skill
{
    ...
    public class SkillEMagicHadesRestraintsShadow extends SkillMagicBase
    {
        ...
        public function SkillEMagicHadesRestraintsShadow(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        private function phaseBullet() : void
        {
            ...
            var _loc_2:* = this.getSpeedVector(_loc_1, _targetGrandPos, this.BULLET_SPEED);
            var _loc_3:* = this.getHitTime(_loc_1, _targetGrandPos, this.BULLET_SPEED);
        ...
        private function controlBullet(param1:Number) : void
        {
            ...
            while (_loc_2 >= 0)
            {
                ...
                if (_loc_3.bHit)
                {
                    _loc_4 = new EffectMc(_layer.getLayer(LayerBattle.BACK_EFFECT), getResource(), _EFFECT_MC_GRAND, _targetGrandPos, _bReverse);
                    addEffect(_loc_4, this.cbSetEffectPhase);
                    _loc_5 = new EffectMc(_layer.getLayer(LayerBattle.FRONT_EFFECT), getResource(), _EFFECT_MC_HIT, _targetGrandPos, _bReverse);
                    addEffect(_loc_5);
                    _loc_3.release();
        ...
        {
            return ResourcePath.SKILL_ENEMY_PATH + "Magic_Hades_RestraintsShadow.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            var _loc_1:* = [SkillMagicBase._TEMP_CASTING_SE, SoundId.SE_AERO];
            return _loc_1;
        }// end function
