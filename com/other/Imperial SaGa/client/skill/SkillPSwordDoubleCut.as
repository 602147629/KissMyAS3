package skill
{
    ...
    public class SkillPSwordDoubleCut extends SkillPositionBase
    {

        public function SkillPSwordDoubleCut(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_PATH + "Skill_Sword_DoubleCut.swf";
        }// end function
