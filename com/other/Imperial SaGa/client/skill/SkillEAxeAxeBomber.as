package skill
{
    ...
    public class SkillEAxeAxeBomber extends SkillAdvanceBase
    {

        public function SkillEAxeAxeBomber(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_ENEMY_PATH + "Skill_Axe_AxeBomber.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            var _loc_1:* = [SoundId.SE_AXE, SoundId.SE_JUMP2];
            return _loc_1;
        }// end function
