package skill
{
    ...
    public class SkillEMagicWaterAcidSpray extends SkillMagicBase
    {
        ...
        public function SkillEMagicWaterAcidSpray(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        private function controlBullet(param1:Number) : void
        {
            ...
            while (_loc_2 >= 0)
            {
                ...
                if (_loc_6.bHit)
                {
                    ...
                    {
                        _loc_7 = new EffectMc(_layer.getLayer(LayerBattle.FRONT_EFFECT), getResource(), _EFFECT_ACTTION_FRONT, _targetHitFrontPos, _bReverse);
            ...
            switch(param2)
            {
                case _EFFECT_LABEL_DAMAGE_LAST:
                {
                    ...
                    while (_loc_3 < _aTarget.length)
                    {
                        ...
                        if (_loc_3 == 0)
                        {
                            _loc_5 = new EffectMc(_layer.getLayer(LayerBattle.FRONT_EFFECT), getResource(), _EFFECT_MC_HIT, _loc_4.characterDisplay.pos, _bReverse);
        ...
        {
            return ResourcePath.SKILL_ENEMY_PATH + "Magic_Water_AcidSpray.swf";
        }// end function
