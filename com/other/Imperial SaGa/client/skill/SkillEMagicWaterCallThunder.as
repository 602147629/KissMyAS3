package skill
{
    ...
    public class SkillEMagicWaterCallThunder extends SkillMagicBase
    {
        private var _formationPos:Point;

        public function SkillEMagicWaterCallThunder(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
            var _loc_7:* = null;
        ...
        {
            return ResourcePath.SKILL_ENEMY_PATH + "Magic_Water_CallThunder.swf";
        }// end function
