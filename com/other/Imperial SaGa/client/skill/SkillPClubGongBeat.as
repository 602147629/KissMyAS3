package skill
{
    ...
    public class SkillPClubGongBeat extends SkillAdvanceBase
    {

        public function SkillPClubGongBeat(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_PATH + "Skill_Club_GongBeat.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            var _loc_1:* = [SoundId.SE_GARYU, SoundId.SE_ATACK3, SoundId.SE_JUMP2];
            return _loc_1;
        }// end function
