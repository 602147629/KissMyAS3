package skill
{
    ...
    public class SkillESwordDeathSword extends SkillPositionBase
    {

        public function SkillESwordDeathSword(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_ENEMY_PATH + "Skill_Sword_DeathSword.swf";
        }// end function
