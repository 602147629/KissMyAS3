package skill
{
    ...
    public class SkillPAttackBow extends SkillPositionBase
    {
        private const _PHASE_BULLET:int = 20;
        private const _PHASE_HIT:int = 30;
        private var _aBullet:Array;
        private const _SHOT_SPEED:int = 2000;

        public function SkillPAttackBow(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_PATH + "Attack_Bow.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            var _loc_1:* = [SoundId.SE_ARROW_HIT, SoundId.SE_RS3_BOW_BOW_ATTACK_NORMAL];
            return _loc_1;
        }// end function
