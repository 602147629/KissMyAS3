package skill
{
    ...
    public class SkillPSwordStraightSlash extends SkillAdvanceBase
    {

        public function SkillPSwordStraightSlash(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_PATH + "Skill_Sword_StraightSlash.swf";
        }// end function
