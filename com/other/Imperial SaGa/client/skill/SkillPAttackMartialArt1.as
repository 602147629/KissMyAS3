package skill
{
    ...
    public class SkillPAttackMartialArt1 extends SkillPositionBase
    {

        public function SkillPAttackMartialArt1(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_PATH + "Attack_MartialArt1.swf";
        }// end function
