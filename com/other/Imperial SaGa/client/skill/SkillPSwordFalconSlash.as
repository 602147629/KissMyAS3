package skill
{
    ...
    public class SkillPSwordFalconSlash extends SkillPositionBase
    {

        public function SkillPSwordFalconSlash(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_PATH + "Skill_Sword_FalconSlash.swf";
        }// end function
