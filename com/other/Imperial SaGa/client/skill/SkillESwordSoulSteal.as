package skill
{
    ...
    public class SkillESwordSoulSteal extends SkillMagicBase
    {
        ...
        public function SkillESwordSoulSteal(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        override protected function createBaseMc(param1:String) : void
        {
            ...
            this._skillUserEffectNull = _skillUserDisplay.pos.add(new Point(_loc_2.tx, _loc_2.ty));
        ...
        private function controlBullet(param1:Number) : void
        {
            ...
            if (this._waitTime > 0)
            {
                ...
                if (this._waitTime <= 0)
                {
                    ...
                    var _loc_11:* = this;
                    var _loc_12:* = this.count + 1;
                    _loc_11.count = _loc_12;
                }
            }
            ...
            if (this._aBullet.length == 0 && this._aMoveBullet.length == 0 && this._aBulletUp.length == 0 && this._aMoveBulletUp.length == 0 && this._aBulletDown.length == 0 && this._aMoveBulletDown.length == 0)
            {
                if (_skillUser.type == CharacterDisplayBase.TYPE_ENEMY)
                {
                    ...
                    addEffect(_loc_9, this.cbSetEffectPhase, this.cbEffectControl);
                    skillUserPosMove(_skillUser, _EFFECT_MC_GRAND);
                    _loc_10 = new EffectMc(_layer.getLayer(LayerBattle.BACK_EFFECT), getResource(), _EFFECT_MC_GRAND, _buffTargetDisPlay, _bReverse);
                    addEffect(_loc_10);
                }
                else
                {
        ...
        {
            return ResourcePath.SKILL_ENEMY_PATH + "Skill_Sword_SoulSteal.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            var _loc_1:* = [SoundId.SE_BATTLE_SPACE, SoundId.SE_WINDOW_CLOSE, SoundId.SE_CHARM];
            return _loc_1;
        }// end function
