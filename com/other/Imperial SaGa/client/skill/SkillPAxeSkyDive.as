package skill
{
    ...
    public class SkillPAxeSkyDive extends SkillPositionBase
    {
        ...
        public function SkillPAxeSkyDive(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        private function cbSetEffectPhase(param1:EffectMc, param2:String) : void
        {
            switch(param2)
            {
                ...
                {
                    SoundManager.getInstance().playSe(SoundId.SE_RS3_AXE_YO_YO_HIT_AXE_LIGHT);
        ...
        {
            return ResourcePath.SKILL_PATH + "Skill_Axe_SkyDive.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            var _loc_1:* = [SoundId.SE_RS3_AXE_TOMAHAWK_FLYING_AXE, SoundId.SE_RS3_AXE_YO_YO_HIT_AXE_LIGHT, SoundId.SE_REV_AXE_SKYDRIVE_JUMP];
            return _loc_1;
        }// end function
