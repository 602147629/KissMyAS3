package skill
{
    ...
    public class SkillPSpearCharge extends SkillAdvanceBase
    {

        public function SkillPSpearCharge(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_PATH + "Skill_Spear_Charge.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            var _loc_1:* = [SoundId.SE_RS3_SPEAR_CHARGE, SoundId.SE_RS3_SPEAR_CHARGE_STAB_WITH_A_SPEAR, SoundId.SE_JUMP2];
            return _loc_1;
        }// end function
