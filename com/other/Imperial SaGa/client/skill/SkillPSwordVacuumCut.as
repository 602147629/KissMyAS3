package skill
{
    ...
    public class SkillPSwordVacuumCut extends SkillPositionBase
    {

        public function SkillPSwordVacuumCut(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            super.phaseAction();
            var _loc_1:* = new EffectMc(_layer.getLayer(LayerBattle.FRONT_EFFECT), getResource(), "action_grand", _targetGrandPos, _bReverse);
        ...
        {
            return ResourcePath.SKILL_PATH + "Skill_Sword_VacuumCut.swf";
        }// end function
