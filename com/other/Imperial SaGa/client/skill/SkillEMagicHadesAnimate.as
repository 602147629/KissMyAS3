package skill
{
    ...
    public class SkillEMagicHadesAnimate extends SkillMagicBase
    {

        public function SkillEMagicHadesAnimate(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_ENEMY_PATH + "Magic_Hades_Animate.swf";
        }// end function
