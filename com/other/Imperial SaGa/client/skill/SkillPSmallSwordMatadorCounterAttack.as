package skill
{
    ...
    public class SkillPSmallSwordMatadorCounterAttack extends SkillPositionBase
    {

        public function SkillPSmallSwordMatadorCounterAttack(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            var _loc_1:* = [SoundId.SE_JUMP3, SoundId.SE_ATACK1];
            return _loc_1;
        }// end function
