package skill
{
    ...
    public class SkillPClubEarthSplitAttack extends SkillPositionBase
    {
        private var _shake:EffectShake;

        public function SkillPClubEarthSplitAttack(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_PATH + "Skill_Club_EarthSplitAttack.swf";
        }// end function
