package skill
{
    ...
    public class SkillPMartialArtCounterCounterAttack extends SkillPositionBase
    {

        public function SkillPMartialArtCounterCounterAttack(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            var _loc_1:* = [SoundId.SE_RS3_BLOW_PUNCH, SoundId.SE_REV_MART_COUNTER_SWISH];
            return _loc_1;
        }// end function
