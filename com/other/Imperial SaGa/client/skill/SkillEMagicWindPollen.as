package skill
{
    ...
    public class SkillEMagicWindPollen extends SkillMagicBase
    {

        public function SkillEMagicWindPollen(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_ENEMY_PATH + "Magic_Wind_Pollen.swf";
        }// end function
