package skill
{
    ...
    public class SkillPMagicHadesweakness extends SkillMagicBase
    {

        public function SkillPMagicHadesweakness(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
            ...
            if (_bValidateMain)
            {
                switch(_baseMc.currentLabel)
                {
                    case _ACT_LABEL_HIT:
                    {
                        ...
                        _loc_2 = new EffectMc(_layer.getLayer(LayerBattle.BACK_EFFECT), getResource(), _EFFECT_MC_GRAND, _targetDisplay.pos, _bReverse);
                        addEffect(_loc_2);
                        break;
                    }
                    case _ACT_LABEL_END:
        ...
        {
            return ResourcePath.SKILL_PATH + "Magic_Hades_weakness.swf";
        }// end function
