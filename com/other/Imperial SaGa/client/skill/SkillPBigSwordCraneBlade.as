package skill
{
    ...
    public class SkillPBigSwordCraneBlade extends SkillPositionBase
    {

        public function SkillPBigSwordCraneBlade(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_PATH + "Skill_BigSword_CraneBlade.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            var _loc_1:* = [SoundId.SE_ATACK5, SoundId.SE_AXE, SoundId.SE_AXE_SWISH];
            return _loc_1;
        }// end function
