package skill
{
    ...
    public class SkillPAttackSword extends SkillPositionBase
    {

        public function SkillPAttackSword(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
