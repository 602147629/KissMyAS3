package skill
{
    ...
    public class SkillEMagicHeavenPsychoBind extends SkillMagicBase
    {
        ...
        public function SkillEMagicHeavenPsychoBind(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
            ...
            while (_loc_2 >= 0)
            {
                ...
                if (_loc_6.bHit)
                {
                    if (this._bAddEffect == false)
                    {
                        ...
                        addEffect(_loc_8, this.cbSetEffectPhase, cbEffectControl);
        ...
        {
            return ResourcePath.SKILL_ENEMY_PATH + "Magic_Heaven_PsychoBind.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            var _loc_1:* = [SkillMagicBase._TEMP_CASTING_SE, SoundId.SE_LIGHT2];
            return _loc_1;
        }// end function
