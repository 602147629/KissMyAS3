package skill
{
    ...
    public class SkillPBowRapidFire extends SkillPositionBase
    {
        private var _bDamageMotion:Boolean = false;

        public function SkillPBowRapidFire(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        private function cbSetEffectPhase(param1:EffectMc, param2:String) : void
        {
            switch(param2)
            {
                case _EFFECT_LABEL_DAMAGE:
                {
                    ...
                    {
                        SoundManager.getInstance().playSe(SoundId.SE_REV_BOW_RENSYA_HITS);
                ...
                {
                    SoundManager.getInstance().playSe(SoundId.SE_REV_BOW_RENSYA_LAST);
                    if (this._bDamageMotion == false)
                    {
        ...
        {
            return ResourcePath.SKILL_PATH + "Skill_Bow_RapidFire.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            var _loc_1:* = [SoundId.SE_REV_BOW_RENSYA_HITS, SoundId.SE_REV_BOW_RENSYA_LAST];
            return _loc_1;
        }// end function
