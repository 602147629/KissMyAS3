package skill
{
    ...
    public class SkillEMagicWaterPoisonMist extends SkillMagicBase
    {

        public function SkillEMagicWaterPoisonMist(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
                        ...
                        for each (_loc_6 in _loc_5)
                        {
                            ...
                            for each (_loc_7 in _aTarget)
                            {
                                ...
                                if (_loc_6.type == 2 && _loc_6.questUniqueId == _loc_7.questUniqueId)
                                {
                                    ...
                                    addEffect(_loc_8, null, this.cbEffectPlayerControl);
                                }
                            }
                        }
                        break;
        ...
        {
            return ResourcePath.SKILL_ENEMY_PATH + "Magic_Water_PoisonMist.swf";
        }// end function

        public static function getResourcePosition() : String
        {
            return ResourcePath.BATTLE_PATH + "UI_BattleMain.swf";
        }// end function
