package skill
{
    ...
    public class SkillEMartialArtStrongestBlow extends SkillPositionBase
    {

        public function SkillEMartialArtStrongestBlow(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_ENEMY_PATH + "Skill_MartialArt_StrongestBlow.swf";
        }// end function
