package skill
{
    ...
    public class SkillPMagicHadesShadowBolt extends SkillMagicBase
    {

        public function SkillPMagicHadesShadowBolt(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_PATH + "Magic_Hades_ShadowBolt.swf";
        }// end function
