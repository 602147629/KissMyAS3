package skill
{
    ...
    public class SkillPMartialArtAirThrow extends SkillPositionBase
    {
        private var offset:Point;

        public function SkillPMartialArtAirThrow(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_PATH + "Skill_MartialArt_AirThrow.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            var _loc_1:* = [SoundId.SE_RS3_BLOW_PUNCH, SoundId.SE_AXE_SWISH];
            return _loc_1;
        }// end function
