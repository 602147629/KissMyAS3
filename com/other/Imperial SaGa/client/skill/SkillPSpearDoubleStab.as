package skill
{
    ...
    public class SkillPSpearDoubleStab extends SkillPositionBase
    {

        public function SkillPSpearDoubleStab(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_PATH + "Skill_Spear_DoubleStab.swf";
        }// end function
