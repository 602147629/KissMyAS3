package skill
{
    ...
    public class SkillEMagicWindColdAir extends SkillMagicBase
    {

        public function SkillEMagicWindColdAir(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_ENEMY_PATH + "Magic_Wind_ColdAir.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            var _loc_1:* = [SkillMagicBase._TEMP_CASTING_SE, SoundId.SE_SNOWSTORM];
            return _loc_1;
        }// end function
