package skill
{
    ...
    public class SkillPBowRapidArrow extends SkillPositionBase
    {
        private const _PHASE_BULLET:int = 20;
        private const _PHASE_HIT:int = 30;
        private var _aBullet:Array;
        private const _ARROW_SPEED:int = 5000;

        public function SkillPBowRapidArrow(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            super.controlAction();
            if (_baseMc.isPlaying && _baseMc.currentFrame == 8)
            {
                SoundManager.getInstance().playSe(SoundId.SE_RS3_BOW_FAST_ARROW_POW_CHARGE);
            }
            if (_bValidateMain)
            {
        ...
        {
            return ResourcePath.SKILL_PATH + "Skill_Bow_InstantArrow.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            var _loc_1:* = [SoundId.SE_RS3_BOW_FAST_ARROW_POW_CHARGE, SoundId.SE_ARROW_HIT];
            return _loc_1;
        }// end function
