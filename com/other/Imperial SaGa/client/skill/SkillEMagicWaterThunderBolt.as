package skill
{
    ...
    public class SkillEMagicWaterThunderBolt extends SkillMagicBase
    {

        public function SkillEMagicWaterThunderBolt(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_ENEMY_PATH + "Magic_Water_ThunderBolt.swf";
        }// end function
