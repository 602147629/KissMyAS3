package skill
{
    ...
    public class SkillEAxeDeathsScythe extends SkillPositionBase
    {

        public function SkillEAxeDeathsScythe(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_ENEMY_PATH + "Skill_Axe_DeathsScythe.swf";
        }// end function
