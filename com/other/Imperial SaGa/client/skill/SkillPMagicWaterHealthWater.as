package skill
{
    ...
    public class SkillPMagicWaterHealthWater extends SkillMagicBase
    {

        public function SkillPMagicWaterHealthWater(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_PATH + "Magic_Water_HealthWater.swf";
        }// end function
