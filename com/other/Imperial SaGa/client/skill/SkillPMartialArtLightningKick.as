package skill
{
    ...
    public class SkillPMartialArtLightningKick extends SkillAdvanceBase
    {

        public function SkillPMartialArtLightningKick(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        private function cbSetEffectPhase(param1:EffectMc, param2:String) : void
        {
            switch(param2)
            {
                case _EFFECT_LABEL_DAMAGE_LAST:
                {
                    ...
                    SoundManager.getInstance().playSe(SoundId.SE_ELECTRIC_SHOCK, 0.5);
                    playDamageAll();
                    break;
                }
                default:
        ...
        {
            return ResourcePath.SKILL_PATH + "Skill_MartialArt_LightningKick.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            var _loc_1:* = [SoundId.SE_RS3_BLOW_PUNCH, SoundId.SE_REV_BIGSWORD_TSUBAME_SHINE, SoundId.SE_JUMP2, SoundId.SE_ELECTRIC_SHOCK];
            return _loc_1;
        }// end function
