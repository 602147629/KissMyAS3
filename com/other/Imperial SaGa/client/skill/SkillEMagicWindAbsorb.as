package skill
{
    ...
    public class SkillEMagicWindAbsorb extends SkillMagicBase
    {
        ...
        public function SkillEMagicWindAbsorb(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_ENEMY_PATH + "Magic_Wind_Absorb.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            var _loc_1:* = [SkillMagicBase._TEMP_CASTING_SE, SoundId.SE_BATTLE_WIND, SoundId.SE_WINDOW_CLOSE, SoundId.SE_CHARM];
            return _loc_1;
        }// end function
