package skill
{
    ...
    public class SkillPMagicWindWindCutter extends SkillMagicBase
    {
        ...
        private const WAIT_INTERVAL:Number = 0.08;
        private const BULLET_SPEED:int = 2000;
        private var _bAddEffect:Boolean;

        public function SkillPMagicWindWindCutter(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        private function phaseBullet() : void
        {
            ...
            var _loc_4:* = this.getSpeedVector(_loc_1, _targetGrandPos, this.BULLET_SPEED);
            var _loc_5:* = this.getHitTime(_loc_1, _targetGrandPos, this.BULLET_SPEED);
            var _loc_6:* = 0;
            while (_loc_6 < 4)
            {
                
                _loc_7 = {vec:_loc_4, time:_loc_5, pos:_loc_1};
        ...
        private function controlBullet(param1:Number) : void
        {
            ...
            while (_loc_2 >= 0)
            {
                ...
                if (_loc_6.bHit)
                {
                    ...
                    {
                        _loc_7 = new EffectMc(_layer.getLayer(LayerBattle.FRONT_EFFECT), getResource(), _EFFECT_MC_GRAND, _targetGrandPos, _bReverse);
                        addEffect(_loc_7, this.cbSetEffectPhase);
                        this._bAddEffect = true;
                        _targetDisplay.setAnimDamageLoop();
                    }
                    _loc_6.release();
        ...
        private function cbSetEffectPhase(param1:EffectMc, param2:String) : void
        {
            switch(param2)
            {
                ...
                {
                    _targetDisplay.setAnimDamageLoopRelease();
                    playDamageAll();
                    break;
                }
        ...
        {
            return ResourcePath.SKILL_PATH + "Magic_Wind_WindCutter.swf";
        }// end function

        public static function getSeIdList() : Array
        {
            var _loc_1:* = [SkillMagicBase._TEMP_CASTING_SE, SoundId.SE_RS3_SWORD_LONG_SWORD_NORMAL_ATTACK];
            return _loc_1;
        }// end function
