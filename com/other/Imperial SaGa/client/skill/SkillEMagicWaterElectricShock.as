package skill
{
    ...
    public class SkillEMagicWaterElectricShock extends SkillMagicBase
    {

        public function SkillEMagicWaterElectricShock(param1:LayerBattle, param2:BattleActionBase, param3:Array, param4:Boolean, param5:EffectManager)
        {
        ...
        {
            return ResourcePath.SKILL_ENEMY_PATH + "Magic_Water_ElectricShock.swf";
        }// end function
