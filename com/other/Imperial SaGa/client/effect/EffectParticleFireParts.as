package effect
{
    ...
    public class EffectParticleFireParts extends Object
    {
        ...
        private var _fireBitmap:BitmapData = null;
        ...
        public function EffectParticleFireParts(param1:BitmapData, param2:BitmapData, param3:Point, param4:Number)
        {
            this._vecFriction = 0;
            this._parent = param1;
            this._fireBitmap = param2.clone();
        ...
        public function release() : void
        {
            if (this._fireBitmap)
            {
                this._fireBitmap.dispose();
            }
            this._fireBitmap = null;
            this._parent = null;
            return;
        }// end function
        ...
        public function control(param1:Number) : void
        {
            ...
            else
            {
                ...
                this._alpha = this._maxAlpha * (_loc_2 / 0.2);
            }
            if (this._alpha < 0)
            {
                this._alpha = 0;
        ...
        public function draw() : void
        {
            ...
            _loc_1.translate((-this._fireBitmap.width) * 0.5, (-this._fireBitmap.height) * 0.5);
            if (this._bReverse)
            {
            ...
            this._parent.draw(this._fireBitmap, _loc_1, _loc_2, this._blendMode, null, this._bSmoothing);
            return;
        }// end function
