package effect
{
    ...
    public class EffectParticleBossFireMain extends EffectParticleBossMainBase
    {
        private var _fireBitmapData:BitmapData;

        public function EffectParticleBossFireMain(param1:BitmapData, param2:DisplayObjectContainer, param3:Function, param4:Number, param5:String, param6:Point)
        {
            ...
            this._fireBitmapData = _loc_8;
            _offset.x = -_bmp.x;
            _offset.y = -_bmp.y;
            return;
        }// end function

        public function get fireBitmapData() : BitmapData
        {
            return this._fireBitmapData;
        }// end function
        ...
        override public function release() : void
        {
            ...
            _aParticle = [];
            if (this._fireBitmapData != null)
            {
                this._fireBitmapData.dispose();
            }
            this._fireBitmapData = null;
            return;
        }// end function
        ...
        public function addEffect(param1:EffectParticleFireParts) : void
        {
