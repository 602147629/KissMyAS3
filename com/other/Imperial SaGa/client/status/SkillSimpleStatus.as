package status
{
    ...
    public class SkillSimpleStatus extends Object
    {
        ...
        public function SkillSimpleStatus(param1:DisplayObjectContainer, param2:Point = null, param3:Boolean = true)
        {
            this._mcBase = ResourceManager.getInstance().createMovieClip(ResourcePath.COMMON_DATA_PATH + "UI_Status.swf", "SkillInfoBalloon");
