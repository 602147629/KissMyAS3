package PlayerCard
{
    ...
    public class PlayerSmallCard extends Object
    {
        private var _mcBase:MovieClip;
        private var _mcWeaponIcon:MovieClip;
        private var _layer:LayerPlayerSmallCard;
        private var _playerId:int;

        public function PlayerSmallCard(param1:MovieClip, param2:int = 0)
        {
            this._mcBase = param1;
            this._layer = new LayerPlayerSmallCard();
            this._mcBase.addChild(this._layer);
            this._mcWeaponIcon = ResourceManager.getInstance().createMovieClip(ResourcePath.CARD_PATH + "CardWeaponIcon.swf", "dummyCardSmallMc");
            this._layer.getLayer(LayerPlayerSmallCard.WEAPON_ICON).addChild(this._mcWeaponIcon);
        ...
        public function setPlayerId(param1:int) : void
        {
            ...
            this._layer.getLayer(LayerPlayerSmallCard.CARD).removeChildren();
            var _loc_2:* = PlayerManager.getInstance().getPlayerInformation(this._playerId);
            if (_loc_2)
            {
                _loc_3 = ResourceManager.getInstance().createBitmap(ResourcePath.CARD_SMALL_PATH + CharacterConstant.ID_CARD + _loc_2.cardFileName);
                _loc_3.smoothing = true;
                this._layer.getLayer(LayerPlayerSmallCard.CARD).addChild(_loc_3);
