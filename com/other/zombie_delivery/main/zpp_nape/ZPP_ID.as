package zpp_nape
{
    ...
    public class ZPP_ID extends Object
    {
        ...
        {
            var _loc_1:* = ZPP_ID._Constraint;
            (ZPP_ID._Constraint + 1);
            return _loc_1;
        }// end function

        public static function Interactor() : int
        {
            var _loc_1:* = ZPP_ID._Interactor;
            (ZPP_ID._Interactor + 1);
            return _loc_1;
        }// end function

        public static function CbType() : int
        {
            var _loc_1:* = ZPP_ID._CbType;
            (ZPP_ID._CbType + 1);
            return _loc_1;
        }// end function
        ...
        {
            var _loc_1:* = ZPP_ID._ZPP_SimpleVert;
            (ZPP_ID._ZPP_SimpleVert + 1);
            return _loc_1;
        }// end function

        public static function ZPP_SimpleSeg() : int
        {
            var _loc_1:* = ZPP_ID._ZPP_SimpleSeg;
            (ZPP_ID._ZPP_SimpleSeg + 1);
            return _loc_1;
        }// end function

        public static function InteractionGroup() : int
        {
            var _loc_1:* = ZPP_ID._InteractionGroup;
            (ZPP_ID._InteractionGroup + 1);
            return _loc_1;
        }// end function

        public static function Space() : int
        {
            var _loc_1:* = ZPP_ID._Space;
            (ZPP_ID._Space + 1);
            return _loc_1;
        }// end function
