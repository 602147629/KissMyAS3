package zpp_nape.callbacks
{
    ...
    public class ZPP_ConstraintListener extends ZPP_Listener
    {
        ...
        public function ZPP_ConstraintListener(param1:OptionType = undefined, param2:int = 0, param3:Function = undefined) : void
        {
        ...
        override public function swapEvent(param1:int) : void
        {
            ...
            if (param1 != ZPP_Flags.id_CbEvent_BREAK)
            {
        ...
        override public function removedFromSpace() : void
        {
            ...
            while (_loc_1 != null)
            {
                ...
                _loc_2 = _loc_1.elt;
                _loc_2.conlisteners.remove(this);
                _loc_3 = _loc_2.cbsets.head;
                while (_loc_3 != null)
                {
                    
                    _loc_4 = _loc_3.elt;
                    _loc_4.zip_conlisteners = true;
                    _loc_3 = _loc_3.next;
                }
                _loc_1 = _loc_1.next;
            }
        ...
        override public function addedToSpace() : void
        {
            ...
            var _loc_5:* = null as ZPP_ConstraintListener;
            var _loc_6:* = null as ZNPList_ZPP_ConstraintListener;
            ...
            while (_loc_1 != null)
            {
                ...
                _loc_2 = _loc_1.elt;
                _loc_3 = null;
                _loc_4 = _loc_2.conlisteners.head;
                while (_loc_4 != null)
                {
                ...
                _loc_6 = _loc_2.conlisteners;
                if (ZNPNode_ZPP_ConstraintListener.zpp_pool == null)
                {
                    _loc_7 = new ZNPNode_ZPP_ConstraintListener();
                }
                else
                {
                    _loc_7 = ZNPNode_ZPP_ConstraintListener.zpp_pool;
                    ZNPNode_ZPP_ConstraintListener.zpp_pool = _loc_7.next;
                    _loc_7.next = null;
                }
                _loc_7.elt = this;
                _loc_4 = _loc_7;
