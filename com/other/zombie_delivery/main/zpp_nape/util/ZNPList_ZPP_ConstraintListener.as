package zpp_nape.util
{
    ...
    public class ZNPList_ZPP_ConstraintListener extends Object
    {
        ...
        public function ZNPList_ZPP_ConstraintListener() : void
        {
        ...
        public function setbegin(param1:ZNPNode_ZPP_ConstraintListener) : void
        {
            head = param1;
            modified = true;
            pushmod = true;
        ...
        public function remove(param1:ZPP_ConstraintListener) : void
        {
            ...
            var _loc_7:* = null as ZNPNode_ZPP_ConstraintListener;
            var _loc_2:* = null;
            var _loc_3:* = head;
            var _loc_4:* = false;
            while (_loc_3 != null)
            {
                ...
                if (_loc_3.elt == param1)
                {
                    ...
                    _loc_7 = _loc_5;
                    _loc_7.elt = null;
                    _loc_7.next = ZNPNode_ZPP_ConstraintListener.zpp_pool;
                    ZNPNode_ZPP_ConstraintListener.zpp_pool = _loc_7;
                    modified = true;
                    (length - 1);
                    pushmod = true;
                    _loc_4 = true;
        ...
        public function pop() : void
        {
            ...
            var _loc_2:* = _loc_1;
            _loc_2.elt = null;
            _loc_2.next = ZNPNode_ZPP_ConstraintListener.zpp_pool;
            ZNPNode_ZPP_ConstraintListener.zpp_pool = _loc_2;
            if (head == null)
            {
                pushmod = true;
            }
        ...
        public function insert(param1:ZNPNode_ZPP_ConstraintListener, param2:ZPP_ConstraintListener) : ZNPNode_ZPP_ConstraintListener
        {
            ...
            {
                _loc_4 = new ZNPNode_ZPP_ConstraintListener();
            }
            else
            {
                _loc_4 = ZNPNode_ZPP_ConstraintListener.zpp_pool;
                ZNPNode_ZPP_ConstraintListener.zpp_pool = _loc_4.next;
                _loc_4.next = null;
            }
            _loc_4.elt = param2;
            var _loc_3:* = _loc_4;
        ...
        public function inlined_try_remove(param1:ZPP_ConstraintListener) : Boolean
        {
            var _loc_5:* = null as ZNPNode_ZPP_ConstraintListener;
            var _loc_6:* = null as ZNPNode_ZPP_ConstraintListener;
            var _loc_7:* = null as ZNPNode_ZPP_ConstraintListener;
        ...
        public function inlined_remove(param1:ZPP_ConstraintListener) : void
        {
            var _loc_5:* = null as ZNPNode_ZPP_ConstraintListener;
            var _loc_6:* = null as ZNPNode_ZPP_ConstraintListener;
            var _loc_7:* = null as ZNPNode_ZPP_ConstraintListener;
        ...
        public function inlined_erase(param1:ZNPNode_ZPP_ConstraintListener) : ZNPNode_ZPP_ConstraintListener
        {
            ...
            var _loc_4:* = _loc_2;
            _loc_4.elt = null;
            _loc_4.next = ZNPNode_ZPP_ConstraintListener.zpp_pool;
            ZNPNode_ZPP_ConstraintListener.zpp_pool = _loc_4;
            modified = true;
            (length - 1);
            pushmod = true;
            return _loc_3;
        ...
        {
            var _loc_1:* = null as ZNPNode_ZPP_ConstraintListener;
            var _loc_2:* = null as ZNPNode_ZPP_ConstraintListener;
            while (head != null)
            {
        ...
        public function inlined_add(param1:ZPP_ConstraintListener) : ZPP_ConstraintListener
        {
            ...
            if (ZNPNode_ZPP_ConstraintListener.zpp_pool == null)
            {
                _loc_3 = new ZNPNode_ZPP_ConstraintListener();
            }
            else
            {
                _loc_3 = ZNPNode_ZPP_ConstraintListener.zpp_pool;
                ZNPNode_ZPP_ConstraintListener.zpp_pool = _loc_3.next;
                _loc_3.next = null;
            }
            _loc_3.elt = param1;
            var _loc_2:* = _loc_3;
        ...
        public function front() : ZPP_ConstraintListener
        {
            return head.elt;
        }// end function
        ...
        public function begin() : ZNPNode_ZPP_ConstraintListener
        {
            return head;
        }// end function
