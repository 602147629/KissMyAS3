package zpp_nape.util
{
    ...
    public class ZNPList_ZPP_AABBPair extends Object
    {
        ...
        public function ZNPList_ZPP_AABBPair() : void
        {
        ...
        public function setbegin(param1:ZNPNode_ZPP_AABBPair) : void
        {
            head = param1;
            modified = true;
            pushmod = true;
        ...
        {
            var _loc_3:* = null as ZNPNode_ZPP_AABBPair;
            var _loc_1:* = head;
            var _loc_2:* = null;
            while (_loc_1 != null)
            {
        ...
        public function remove(param1:ZPP_AABBPair) : void
        {
            ...
            var _loc_7:* = null as ZNPNode_ZPP_AABBPair;
            var _loc_2:* = null;
            var _loc_3:* = head;
            var _loc_4:* = false;
            while (_loc_3 != null)
            {
                ...
                if (_loc_3.elt == param1)
                {
                    ...
                    _loc_7 = _loc_5;
                    _loc_7.elt = null;
                    _loc_7.next = ZNPNode_ZPP_AABBPair.zpp_pool;
                    ZNPNode_ZPP_AABBPair.zpp_pool = _loc_7;
                    modified = true;
                    (length - 1);
                    pushmod = true;
                    _loc_4 = true;
        ...
        public function pop() : void
        {
            ...
            var _loc_2:* = _loc_1;
            _loc_2.elt = null;
            _loc_2.next = ZNPNode_ZPP_AABBPair.zpp_pool;
            ZNPNode_ZPP_AABBPair.zpp_pool = _loc_2;
            if (head == null)
            {
                pushmod = true;
            }
        ...
        {
            var _loc_4:* = null as ZNPNode_ZPP_AABBPair;
            if (ZNPNode_ZPP_AABBPair.zpp_pool == null)
            {
                _loc_4 = new ZNPNode_ZPP_AABBPair();
            }
            else
            {
                _loc_4 = ZNPNode_ZPP_AABBPair.zpp_pool;
                ZNPNode_ZPP_AABBPair.zpp_pool = _loc_4.next;
                _loc_4.next = null;
            }
            _loc_4.elt = param2;
            var _loc_3:* = _loc_4;
        ...
        public function inlined_try_remove(param1:ZPP_AABBPair) : Boolean
        {
            var _loc_5:* = null as ZNPNode_ZPP_AABBPair;
            var _loc_6:* = null as ZNPNode_ZPP_AABBPair;
            var _loc_7:* = null as ZNPNode_ZPP_AABBPair;
        ...
        public function inlined_remove(param1:ZPP_AABBPair) : void
        {
            var _loc_5:* = null as ZNPNode_ZPP_AABBPair;
            var _loc_6:* = null as ZNPNode_ZPP_AABBPair;
            var _loc_7:* = null as ZNPNode_ZPP_AABBPair;
        ...
        {
            var _loc_2:* = null as ZNPNode_ZPP_AABBPair;
            var _loc_3:* = null as ZNPNode_ZPP_AABBPair;
            if (param1 == null)
            {
                _loc_2 = head;
            ...
            var _loc_4:* = _loc_2;
            _loc_4.elt = null;
            _loc_4.next = ZNPNode_ZPP_AABBPair.zpp_pool;
            ZNPNode_ZPP_AABBPair.zpp_pool = _loc_4;
            modified = true;
            (length - 1);
            pushmod = true;
            return _loc_3;
        ...
        {
            var _loc_1:* = null as ZNPNode_ZPP_AABBPair;
            var _loc_2:* = null as ZNPNode_ZPP_AABBPair;
            while (head != null)
            {
        ...
        public function inlined_add(param1:ZPP_AABBPair) : ZPP_AABBPair
        {
            ...
            if (ZNPNode_ZPP_AABBPair.zpp_pool == null)
            {
                _loc_3 = new ZNPNode_ZPP_AABBPair();
            }
            else
            {
                _loc_3 = ZNPNode_ZPP_AABBPair.zpp_pool;
                ZNPNode_ZPP_AABBPair.zpp_pool = _loc_3.next;
                _loc_3.next = null;
            }
            _loc_3.elt = param1;
            var _loc_2:* = _loc_3;
        ...
        public function front() : ZPP_AABBPair
        {
            return head.elt;
        }// end function
        ...
        public function begin() : ZNPNode_ZPP_AABBPair
        {
            return head;
        }// end function
        ...
        {
            var _loc_3:* = null as ZPP_AABBPair;
