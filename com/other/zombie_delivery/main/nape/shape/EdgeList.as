package nape.shape
{
    ...
    final public class EdgeList extends Object
    {
        public var zpp_inner:ZPP_EdgeList;

        public function EdgeList() : void
        {
        ...
        {
            var _loc_4:* = null as Edge;
            var _loc_5:* = 0;
            var _loc_6:* = null as EdgeList;
            var _loc_1:* = "[";
            var _loc_2:* = true;
            zpp_inner.valmod();
            var _loc_3:* = EdgeIterator.get(this);
            do
            {
            ...
            }while (_loc_3.zpp_i < _loc_5 ? (true) : (_loc_3.zpp_next = EdgeIterator.zpp_pool, EdgeIterator.zpp_pool = _loc_3, _loc_3.zpp_inner = null, false))
            return _loc_1 + "]";
        }// end function

        public function shift() : Edge
        {
            var _loc_2:* = null as ZNPNode_ZPP_Edge;
            var _loc_3:* = null as Edge;
            if (zpp_inner.immutable)
            {
                throw "Error: " + "Edge" + "List is immutable";
            }
        ...
        {
            var _loc_2:* = null as Edge;
            var _loc_3:* = null as ZNPNode_ZPP_Edge;
            if (zpp_inner.immutable)
            {
                throw "Error: " + "Edge" + "List is immutable";
            }
        ...
        public function merge(param1:EdgeList) : void
        {
            ...
            }while (_loc_2.zpp_i < _loc_4 ? (true) : (_loc_2.zpp_next = EdgeIterator.zpp_pool, EdgeIterator.zpp_pool = _loc_2, _loc_2.zpp_inner = null, false))
            return;
        }// end function
        ...
        public function foreach(param1:Function) : EdgeList
        {
            ...
            do
            {
                ...
                ;
                _loc_5 = null;
                _loc_3.zpp_next = EdgeIterator.zpp_pool;
                EdgeIterator.zpp_pool = _loc_3;
                ...
                _loc_3.zpp_critical = true;
            }while (_loc_3.zpp_i < _loc_4 ? (true) : (_loc_3.zpp_next = EdgeIterator.zpp_pool, EdgeIterator.zpp_pool = _loc_3, _loc_3.zpp_inner = null, false))
            return this;
        }// end function
        ...
        public function copy(param1:Boolean = false) : EdgeList
        {
            ...
            do
            {
                ...
                (_loc_3.zpp_i + 1);
                _loc_4 = _loc_3.zpp_inner.at(_loc_5);
                _loc_2.push(param1 ? (throw "Error: " + "Edge" + " is not a copyable type", null) : (_loc_4));
                _loc_3.zpp_inner.zpp_inner.valmod();
                _loc_6 = _loc_3.zpp_inner;
                _loc_6.zpp_inner.valmod();
                if (_loc_6.zpp_inner.zip_length)
