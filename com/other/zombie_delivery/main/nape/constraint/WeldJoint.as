package nape.constraint
{
    ...
    final public class WeldJoint extends Constraint
    {
        public var zpp_inner_zn:ZPP_WeldJoint;

        public function WeldJoint(param1:Body = undefined, param2:Body = undefined, param3:Vec2 = undefined, param4:Vec2 = undefined, param5:Number = 0) : void
        {
            var _loc_7:* = null;
            ...
            var _loc_9:* = zpp_inner_zn.wrap_a1;
            if (_loc_9 != null)
            {
            }
            if (_loc_9.zpp_disp)
            ...
            _loc_10 = param3.zpp_inner;
            if (_loc_10._validate != null)
            {
                _loc_10._validate();
            }
            var _loc_12:* = param3.zpp_inner.x;
            if (param3 != null)
            {
            }
            if (param3.zpp_disp)
            ...
            var _loc_13:* = param3.zpp_inner.y;
            if (_loc_9 != null)
            {
            }
            if (_loc_9.zpp_disp)
            ...
            if (_loc_9.zpp_inner.y != _loc_13)
            {
                _loc_9.zpp_inner.x = _loc_12;
                _loc_9.zpp_inner.y = _loc_13;
                _loc_10 = _loc_9.zpp_inner;
            ...
            _loc_10 = param4.zpp_inner;
            if (_loc_10._validate != null)
            {
                _loc_10._validate();
            }
            _loc_12 = param4.zpp_inner.x;
            if (param4 != null)
            {
            }
            if (param4.zpp_disp)
        ...
        public function set_phase(param1:Number) : Number
        {
            zpp_inner.immutable_midstep("WeldJoint::phase");
            if (param1 != param1)
            {
        ...
        override public function impulse() : MatMN
        {
            ...
            _loc_1.zpp_inner.x[_loc_1.zpp_inner.n] = zpp_inner_zn.jAccz;
            return _loc_1;
        }// end function

        public function get_phase() : Number
        {
            return zpp_inner_zn.phase;
        }// end function
