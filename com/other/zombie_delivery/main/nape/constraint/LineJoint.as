package nape.constraint
{
    ...
    final public class LineJoint extends Constraint
    {
        public var zpp_inner_zn:ZPP_LineJoint;

        public function LineJoint(param1:Body = undefined, param2:Body = undefined, param3:Vec2 = undefined, param4:Vec2 = undefined, param5:Vec2 = undefined, param6:Number = 0, param7:Number = 0) : void
        {
            var _loc_9:* = null;
            ...
            {
                _loc_10 = param1.zpp_inner;
            }
            if (_loc_10 != zpp_inner_zn.b1)
            {
                ...
                if (zpp_inner_zn.b2 != _loc_10)
                {
                    if (_loc_10 != null)
                    {
                        _loc_10.constraints.add(zpp_inner);
                    }
                }
                if (zpp_inner.active)
                {
            ...
            var _loc_11:* = zpp_inner_zn.wrap_a1;
            if (_loc_11 != null)
            {
            }
            if (_loc_11.zpp_disp)
            ...
            _loc_12 = param3.zpp_inner;
            if (_loc_12._validate != null)
            {
                _loc_12._validate();
            }
            var _loc_14:* = param3.zpp_inner.x;
            if (param3 != null)
            {
            }
            if (param3.zpp_disp)
            ...
            var _loc_15:* = param3.zpp_inner.y;
            if (_loc_11 != null)
            {
            }
            if (_loc_11.zpp_disp)
            ...
            if (_loc_11.zpp_inner.x == _loc_14)
            {
                if (_loc_11 != null)
                {
                }
            ...
            if (param3.zpp_inner.weak)
            {
                ...
                _loc_17 = _loc_12;
                if (_loc_17.outer != null)
                {
                    _loc_17.outer.zpp_inner = null;
                    _loc_17.outer = null;
                }
                _loc_17._isimmutable = null;
                _loc_17._validate = null;
                _loc_17._invalidate = null;
                _loc_17.next = ZPP_Vec2.zpp_pool;
                ZPP_Vec2.zpp_pool = _loc_17;
            }
            else
            {
            }
            ...
            _loc_12 = param4.zpp_inner;
            if (_loc_12._validate != null)
            {
                _loc_12._validate();
            }
            _loc_14 = param4.zpp_inner.x;
            if (param4 != null)
            {
            }
            if (param4.zpp_disp)
            ...
            if (param5 == null)
            {
                throw "Error: Constraint::" + "direction" + " cannot be null";
            }
            if (zpp_inner_zn.wrap_n == null)
            {
                zpp_inner_zn.setup_n();
            }
            _loc_11 = zpp_inner_zn.wrap_n;
            if (_loc_11 != null)
            {
            }
            if (_loc_11.zpp_disp)
            ...
            _loc_12 = param5.zpp_inner;
            if (_loc_12._validate != null)
            {
                _loc_12._validate();
            }
            _loc_14 = param5.zpp_inner.x;
            if (param5 != null)
            {
            }
            if (param5.zpp_disp)
        ...
        public function set_direction(param1:Vec2) : Vec2
        {
            ...
            var _loc_2:* = zpp_inner_zn.wrap_n;
            if (_loc_2 != null)
            {
            }
            if (_loc_2.zpp_disp)
