package nape.callbacks
{
    ...
    final public class CbTypeIterator extends Object
    {
        ...
        public function CbTypeIterator() : void
        {
        ...
        {
            var _loc_2:* = null as CbTypeIterator;
            var _loc_3:* = null as CbTypeIterator;
            if (CbTypeIterator.zpp_pool == null)
            {
                ZPP_CbTypeList.internal = true;
                _loc_3 = new CbTypeIterator();
                ZPP_CbTypeList.internal = false;
                _loc_2 = _loc_3;
            }
            else
            {
                _loc_3 = CbTypeIterator.zpp_pool;
                CbTypeIterator.zpp_pool = _loc_3.zpp_next;
                _loc_2 = _loc_3;
            }
            _loc_2.zpp_i = 0;
