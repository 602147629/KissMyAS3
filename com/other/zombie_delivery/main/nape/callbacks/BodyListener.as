package nape.callbacks
{
    ...
    final public class BodyListener extends Listener
    {
        public var zpp_inner_zn:ZPP_BodyListener;

        public function BodyListener(event:CbEvent = undefined, param2 = undefined, param3:Function = undefined, param4:int = 0) : void
        {
            ...
            zpp_inner_zn = new ZPP_BodyListener(ZPP_OptionType.argument(param2), _loc_5, param3);
