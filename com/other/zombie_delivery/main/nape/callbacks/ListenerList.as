package nape.callbacks
{
    ...
    final public class ListenerList extends Object
    {
        public var zpp_inner:ZPP_ListenerList;

        public function ListenerList() : void
        {
        ...
        {
            var _loc_4:* = null as Listener;
            var _loc_5:* = 0;
            var _loc_6:* = null as ListenerList;
            var _loc_1:* = "[";
            var _loc_2:* = true;
            zpp_inner.valmod();
            var _loc_3:* = ListenerIterator.get(this);
            do
            {
            ...
            }while (_loc_3.zpp_i < _loc_5 ? (true) : (_loc_3.zpp_next = ListenerIterator.zpp_pool, ListenerIterator.zpp_pool = _loc_3, _loc_3.zpp_inner = null, false))
            return _loc_1 + "]";
        }// end function
        ...
        public function merge(param1:ListenerList) : void
        {
            var _loc_3:* = null as Listener;
            var _loc_4:* = 0;
            var _loc_5:* = null as ListenerList;
            if (param1 == null)
            {
                throw "Error: Cannot merge with null list";
            }
            param1.zpp_inner.valmod();
            var _loc_2:* = ListenerIterator.get(param1);
            do
            {
            ...
            }while (_loc_2.zpp_i < _loc_4 ? (true) : (_loc_2.zpp_next = ListenerIterator.zpp_pool, ListenerIterator.zpp_pool = _loc_2, _loc_2.zpp_inner = null, false))
            return;
        }// end function
        ...
        public function foreach(param1:Function) : ListenerList
        {
            ...
            do
            {
                ...
                ;
                _loc_5 = null;
                _loc_3.zpp_next = ListenerIterator.zpp_pool;
                ListenerIterator.zpp_pool = _loc_3;
                ...
                _loc_3.zpp_critical = true;
            }while (_loc_3.zpp_i < _loc_4 ? (true) : (_loc_3.zpp_next = ListenerIterator.zpp_pool, ListenerIterator.zpp_pool = _loc_3, _loc_3.zpp_inner = null, false))
            return this;
        }// end function
        ...
        public function copy(param1:Boolean = false) : ListenerList
        {
            ...
            do
            {
                ...
                (_loc_3.zpp_i + 1);
                _loc_4 = _loc_3.zpp_inner.at(_loc_5);
                _loc_2.push(param1 ? (throw "Error: " + "Listener" + " is not a copyable type", null) : (_loc_4));
                _loc_3.zpp_inner.zpp_inner.valmod();
                _loc_6 = _loc_3.zpp_inner;
                _loc_6.zpp_inner.valmod();
                if (_loc_6.zpp_inner.zip_length)
