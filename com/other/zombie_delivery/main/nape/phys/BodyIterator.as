package nape.phys
{
    ...
    final public class BodyIterator extends Object
    {
        ...
        public function BodyIterator() : void
        {
        ...
        {
            var _loc_2:* = null as BodyIterator;
            var _loc_3:* = null as BodyIterator;
            if (BodyIterator.zpp_pool == null)
            {
                ZPP_BodyList.internal = true;
                _loc_3 = new BodyIterator();
                ZPP_BodyList.internal = false;
                _loc_2 = _loc_3;
            }
            else
            {
                _loc_3 = BodyIterator.zpp_pool;
                BodyIterator.zpp_pool = _loc_3.zpp_next;
                _loc_2 = _loc_3;
            }
            _loc_2.zpp_i = 0;
