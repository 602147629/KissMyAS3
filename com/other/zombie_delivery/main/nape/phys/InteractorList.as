package nape.phys
{
    ...
    final public class InteractorList extends Object
    {
        public var zpp_inner:ZPP_InteractorList;

        public function InteractorList() : void
        {
        ...
        {
            var _loc_4:* = null as Interactor;
            var _loc_5:* = 0;
            var _loc_6:* = null as InteractorList;
            var _loc_1:* = "[";
            var _loc_2:* = true;
            zpp_inner.valmod();
            var _loc_3:* = InteractorIterator.get(this);
            do
            {
            ...
            }while (_loc_3.zpp_i < _loc_5 ? (true) : (_loc_3.zpp_next = InteractorIterator.zpp_pool, InteractorIterator.zpp_pool = _loc_3, _loc_3.zpp_inner = null, false))
            return _loc_1 + "]";
        }// end function

        public function shift() : Interactor
        {
            var _loc_2:* = null as ZNPNode_ZPP_Interactor;
            var _loc_3:* = null as Interactor;
            if (zpp_inner.immutable)
            {
                throw "Error: " + "Interactor" + "List is immutable";
            }
        ...
        {
            var _loc_2:* = null as Interactor;
            var _loc_3:* = null as ZNPNode_ZPP_Interactor;
            if (zpp_inner.immutable)
            {
                throw "Error: " + "Interactor" + "List is immutable";
            }
        ...
        public function merge(param1:InteractorList) : void
        {
            var _loc_3:* = null as Interactor;
            var _loc_4:* = 0;
            var _loc_5:* = null as InteractorList;
            if (param1 == null)
            {
                throw "Error: Cannot merge with null list";
            }
            param1.zpp_inner.valmod();
            var _loc_2:* = InteractorIterator.get(param1);
            do
            {
            ...
            }while (_loc_2.zpp_i < _loc_4 ? (true) : (_loc_2.zpp_next = InteractorIterator.zpp_pool, InteractorIterator.zpp_pool = _loc_2, _loc_2.zpp_inner = null, false))
            return;
        }// end function
        ...
        public function foreach(param1:Function) : InteractorList
        {
            ...
            do
            {
                ...
                ;
                _loc_5 = null;
                _loc_3.zpp_next = InteractorIterator.zpp_pool;
                InteractorIterator.zpp_pool = _loc_3;
                ...
                _loc_3.zpp_critical = true;
            }while (_loc_3.zpp_i < _loc_4 ? (true) : (_loc_3.zpp_next = InteractorIterator.zpp_pool, InteractorIterator.zpp_pool = _loc_3, _loc_3.zpp_inner = null, false))
            return this;
        }// end function
        ...
        public function copy(param1:Boolean = false) : InteractorList
        {
            ...
            do
            {
                ...
                (_loc_3.zpp_i + 1);
                _loc_4 = _loc_3.zpp_inner.at(_loc_5);
                _loc_2.push(param1 ? (throw "Error: " + "Interactor" + " is not a copyable type", null) : (_loc_4));
                _loc_3.zpp_inner.zpp_inner.valmod();
                _loc_6 = _loc_3.zpp_inner;
                _loc_6.zpp_inner.valmod();
                if (_loc_6.zpp_inner.zip_length)
