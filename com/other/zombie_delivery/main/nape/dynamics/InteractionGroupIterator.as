package nape.dynamics
{
    ...
    final public class InteractionGroupIterator extends Object
    {
        ...
        public function InteractionGroupIterator() : void
        {
        ...
        {
            var _loc_2:* = null as InteractionGroupIterator;
            var _loc_3:* = null as InteractionGroupIterator;
            if (InteractionGroupIterator.zpp_pool == null)
            {
                ZPP_InteractionGroupList.internal = true;
                _loc_3 = new InteractionGroupIterator();
                ZPP_InteractionGroupList.internal = false;
                _loc_2 = _loc_3;
            }
            else
            {
                _loc_3 = InteractionGroupIterator.zpp_pool;
                InteractionGroupIterator.zpp_pool = _loc_3.zpp_next;
                _loc_2 = _loc_3;
            }
            _loc_2.zpp_i = 0;
