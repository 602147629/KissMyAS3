package nape.dynamics
{
    ...
    final public class InteractionGroupList extends Object
    {
        public var zpp_inner:ZPP_InteractionGroupList;

        public function InteractionGroupList() : void
        {
        ...
        {
            var _loc_4:* = null as InteractionGroup;
            var _loc_5:* = 0;
            var _loc_6:* = null as InteractionGroupList;
            var _loc_1:* = "[";
            var _loc_2:* = true;
            zpp_inner.valmod();
            var _loc_3:* = InteractionGroupIterator.get(this);
            do
            {
            ...
            }while (_loc_3.zpp_i < _loc_5 ? (true) : (_loc_3.zpp_next = InteractionGroupIterator.zpp_pool, InteractionGroupIterator.zpp_pool = _loc_3, _loc_3.zpp_inner = null, false))
            return _loc_1 + "]";
        }// end function
        ...
        public function shift() : InteractionGroup
        {
            ...
            var _loc_3:* = null as InteractionGroup;
            if (zpp_inner.immutable)
            {
                throw "Error: " + "InteractionGroup" + "List is immutable";
            }
        ...
        {
            var _loc_2:* = null as InteractionGroup;
        ...
        public function merge(param1:InteractionGroupList) : void
        {
            var _loc_3:* = null as InteractionGroup;
            var _loc_4:* = 0;
            var _loc_5:* = null as InteractionGroupList;
            if (param1 == null)
            {
                throw "Error: Cannot merge with null list";
            }
            param1.zpp_inner.valmod();
            var _loc_2:* = InteractionGroupIterator.get(param1);
            do
            {
            ...
            }while (_loc_2.zpp_i < _loc_4 ? (true) : (_loc_2.zpp_next = InteractionGroupIterator.zpp_pool, InteractionGroupIterator.zpp_pool = _loc_2, _loc_2.zpp_inner = null, false))
            return;
        }// end function
        ...
        public function foreach(param1:Function) : InteractionGroupList
        {
            ...
            do
            {
                ...
                ;
                _loc_5 = null;
                _loc_3.zpp_next = InteractionGroupIterator.zpp_pool;
                InteractionGroupIterator.zpp_pool = _loc_3;
                ...
                _loc_3.zpp_critical = true;
            }while (_loc_3.zpp_i < _loc_4 ? (true) : (_loc_3.zpp_next = InteractionGroupIterator.zpp_pool, InteractionGroupIterator.zpp_pool = _loc_3, _loc_3.zpp_inner = null, false))
            return this;
        }// end function
        ...
        public function copy(param1:Boolean = false) : InteractionGroupList
        {
            ...
            var _loc_5:* = 0;
            var _loc_6:* = null as InteractionGroupList;
            var _loc_2:* = new InteractionGroupList();
            zpp_inner.valmod();
            var _loc_3:* = InteractionGroupIterator.get(this);
            do
            {
                ...
                (_loc_3.zpp_i + 1);
                _loc_4 = _loc_3.zpp_inner.at(_loc_5);
                _loc_2.push(param1 ? (throw "Error: " + "InteractionGroup" + " is not a copyable type", null) : (_loc_4));
                _loc_3.zpp_inner.zpp_inner.valmod();
                _loc_6 = _loc_3.zpp_inner;
                _loc_6.zpp_inner.valmod();
                if (_loc_6.zpp_inner.zip_length)
